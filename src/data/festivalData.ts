...
export const DEFAULT_HERO_MEDIA: HeroMedia[] = [
  { id: 'hm-1', type: 'image', url: '/hero1.jpg', title: 'Inaugural Session', caption: 'tabassum Meelad Fest' },
  { id: 'hm-2', type: 'image', url: '/hero2.jpg', title: 'Festival Scholars', caption: 'tabassum Meelad Fest' }
];
