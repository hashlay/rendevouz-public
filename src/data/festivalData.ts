...
export const DEFAULT_HERO_MEDIA: HeroMedia[] = [
  { id: 'hm-1', type: 'image', url: '/rendezvous_poster.jpg', title: 'Inaugural Session', caption: 'Rendezvous 26' },
  { id: 'hm-2', type: 'image', url: '/rendezvous_logo.png', title: 'Festival Scholars', caption: 'Rendezvous 26' }
];
...
export const STAGES_DATA: Stage[] = [
  {
    ...
    location: 'Imam Rabbani Central Campus',
    streamUrl: '',
    videoEmbedId: '',
    isLive: false,
    currentProgram: '',
...
export const FULL_CONCEPT_TEXT = {
  title: "DECODING PHYTOLORE",
  institution: "Imam Rabbani Life Festival",
  badge: "Theme Concept & Philosophy",
  footer: "Rendezvous 26",
  paragraphs: [
    "Decoding Phytolore delves into the profound wisdom of natural heritage, botanical lore, and life systems woven into sacred traditions and intellectual history.",
